"""Pure DTO and Protocol contracts shared by Citeframe backend processes."""
...
@runtime_checkable
class EvidenceToolRegistryProtocol(Protocol):
    """Structural surface exposed to a researcher by the worker registry."""
    ...
    def load(self, *, evidence_handles: Sequence[str]) -> Sequence[LoadedEvidence]: ...
...
class Researcher(Protocol):
    def __call__(
        ...
        tools: EvidenceToolRegistryProtocol,
        lease: StepLease | None = None,
    ) -> BranchResult: ...
