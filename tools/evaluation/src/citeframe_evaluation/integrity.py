...
from citeframe_evaluation.contracts import R803EvaluationError, file_sha256
...
_PACKAGE_SOURCE_ROOTS: dict[str, str] = {
    "citeframe_evaluation": "tools/evaluation/src",
    "citeframe_research_persistence": "packages/research-persistence/src",
...
def scorer_implementation_sha256(repo_root: Path) -> str:
    return module_file_sha256(
        repo_root,
        "tools/evaluation/src/citeframe_evaluation/scoring.py",
    )
