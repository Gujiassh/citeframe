...
WORKFLOW_VERSION_ID = V4_WORKFLOW_VERSION_ID
PROMPT_VERSION_IDS = V4_PROMPT_VERSION_IDS
PROMPT_VERSION_HASHES = {
    node_key: spec.template_sha256 for node_key, spec in V4_PROMPT_SPECS.items()
}
