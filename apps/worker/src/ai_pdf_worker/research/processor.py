"""Claim and process one persisted Research attempt with Worker-owned transaction boundaries."""
...
from ai_pdf_worker.research.handlers import SingleAttemptStepDispatcher
